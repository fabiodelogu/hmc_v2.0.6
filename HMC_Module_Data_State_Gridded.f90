...
#ifdef LIB_NC
    use HMC_Module_Tools_IO,        only:   HMC_Tools_IO_Put2d_Binary, &
...
contains
    ...
    subroutine HMC_Data_State_Gridded_NC(iID,  &
        ...
        integer(kind = 4)       :: iID_Dim_Rows, iID_Dim_Cols, iID_Dim_Time, iID_Dim_TMarkedSteps, iID_Dim_DaySteps
        !------------------------------------------------------------------------------------------
        ...
        call check( nf90_def_dim(iFileID, "day_steps", iDaySteps, iID_Dim_DaySteps) )
        !------------------------------------------------------------------------------------------
        ...
        sVarUnits = 'K'; sVarGridMap = 'epsg:4326'; dVarMissingValue = -9E15;
        sVarCoords = 'Longitude Latitude';
        call HMC_Tools_IO_Put3d_NC(iFileID, iID_Dim_Cols, iID_Dim_Rows, iID_Dim_DaySteps, & 
                             sVarName, sVarNameLong, sVarDescription, &
                             sVarUnits, sVarCoords, sVarGridMap, dVarMissingValue, &
    ...
    subroutine HMC_Data_State_Gridded_Binary(iID, &
        ...
        ! VTot
        iVarScale = 10000
        sFileNameData_State = trim(sPathData_State)//"VTot_"// &
        ...
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarVTot, iRows, iCols, iVarScale, .true., iErr)
        ...
        ! VRet
        iVarScale = 10000
        sFileNameData_State = trim(sPathData_State)//"VRet_"// &
                           sTime(1:4)//sTime(6:7)//sTime(9:10)//sTime(12:13)//sTime(15:16)// &
                           ".bin"    
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarVRet, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                       sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        ! Hydro
        iVarScale = 100000
        sFileNameData_State = trim(sPathData_State)//"HydroLevel_"// &
                           sTime(1:4)//sTime(6:7)//sTime(9:10)//sTime(12:13)//sTime(15:16)// &
                           ".bin"            
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarHydro, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                       sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        ! Routing
        iVarScale = 100000
        sFileNameData_State = trim(sPathData_State)//"Routing_"// &
                           sTime(1:4)//sTime(6:7)//sTime(9:10)//sTime(12:13)//sTime(15:16)// &
                           ".bin"            
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarRouting, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                                     sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        sFileNameData_State = trim(sPathData_State)//"DFE_"// &
                           ...
                           ".bin"            
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarFlowDeep, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                       sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        ! Water-table level
        iVarScale = 10000
        sFileNameData_State = trim(sPathData_State)//"WTLevel_"// &
                           sTime(1:4)//sTime(6:7)//sTime(9:10)//sTime(12:13)//sTime(15:16)// &
                           ".bin"            
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarWTableUpd, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                       sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        iVarScale = 10000
        sFileNameData_State = trim(sPathData_State)//"LST_"// &
                           sTime(1:4)//sTime(6:7)//sTime(9:10)//sTime(12:13)//sTime(15:16)// &
                           ".bin"            
        call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
        call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarLST, iRows, iCols, iVarScale, .true., iErr)
        call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                                       sFileNameData_State//'.gz', sFileNameData_State, .false.)
        call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_State, .false.)
        ...
        if (iFlagSnow.eq.1) then
            ...
            sFileNameData_State = trim(sPathData_State)//"SWE_"// &
                                ...
                                ".bin"            
            call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
            call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarSWE, iRows, iCols, iVarScale, .true., iErr)  
            call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                        sFileNameData_State//'.gz', sFileNameData_State, .false.)
            ...
            sFileNameData_State = trim(sPathData_State)//"Density_"// &
                                ...
                                ".bin"            
            call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
            call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarRhoS, iRows, iCols, iVarScale, .true., iErr)  
            call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                        sFileNameData_State//'.gz', sFileNameData_State, .false.)
            !call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_Output, .false. )
            ...
            sFileNameData_State = trim(sPathData_State)//"AlbedoS_"// &
                                ...
                                ".bin"            
            call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
            call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, a2dVarAlbedoS, iRows, iCols, iVarScale, .true., iErr)  
            call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                        sFileNameData_State//'.gz', sFileNameData_State, .false.)
            !call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_Output, .false. )
            ...
            sFileNameData_State = trim(sPathData_State)//"Age_"// &
                                ...
                                ".bin"            
            call mprintf(.true., iINFO_Extra, ' Save filename: '//trim(sFileNameData_State) )
            call HMC_Tools_IO_Put2d_Binary(sFileNameData_State, real(a2iVarAgeS), iRows, iCols, iVarScale, .true., iErr)  
            call HMC_Tools_Generic_ZipFile(oHMC_Namelist(iID)%sCommandZipFile, &
                        sFileNameData_State//'.gz', sFileNameData_State, .false.)
            !call HMC_Tools_Generic_RemoveFile(oHMC_Namelist(iID)%sCommandRemoveFile, sFileNameData_Output, .false. )
