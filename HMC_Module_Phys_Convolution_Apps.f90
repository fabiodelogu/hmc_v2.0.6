...
contains 
    ...
    subroutine HMC_Phys_Convolution_Apps_IntegrationStep(iID, iRows, iCols, dDtDataForcing, dDtIntegrAct)
        ...
        !call debug_2dVar(dble(a2dVarRain), iRows, iCols, 4)
        ...
        if (iFlagVarDtPhysConv.eq.1 ) then
            ...
            if ( (dDEMStepMean.ge.10) .and. (dDEMStepMean.lt.150) ) then
                dDtRef = 5.0; ! seconds
                dDtIntegrMin = 5.0; ! seconds
                dDtRefRatio = 3.0; 
            elseif ( dDEMStepMean.lt.10 ) then 
                dDtRef = 1.0; ! seconds
                dDtIntegrMin = 1.0; ! seconds
                dDtRefRatio = 3.0; 
    ...
    subroutine HMC_Phys_Convolution_Apps_HydraulicStructure(iID, iRows, iCols, &
        ...
        !------------------------------------------------------------------------------------------
        ! Method to compute dam discharge 
