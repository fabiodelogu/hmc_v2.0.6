...
contains
    ...
    subroutine HMC_Tools_Debug_SetUnit(iDebugUnit)
        ...
        logical                 :: bIsUsed
        integer(kind = 4)       :: iDebugUnit, iDebugUnitMin, iDebugUnitMax
        integer(kind = 4)       :: iDebugUnitInit
        !------------------------------------------------------------------------------------------
        
        !------------------------------------------------------------------------------------------
        ! Initialize variable(s)
        iDebugUnitMin = 80; iDebugUnitMax = 100;
        !------------------------------------------------------------------------------------------
