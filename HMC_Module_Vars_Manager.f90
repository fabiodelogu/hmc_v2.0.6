...
contains
    ...
    subroutine HMC_Vars_Allocate(iID, &
        ...
        allocate( oHMC_Vars(iID)%a3dTaC120          (iRows, iCols, iDaySteps*5) )
    ...
    subroutine HMC_Vars_InitDefault(iID)
        ...
        oHMC_Vars(iID)%bLogForcingPoint = .false.
        ...
        ! Static land-data HMC model variable(s)
        ...
        ! Static infiltration (horton) HMC model variable(s)
        ...
        ! Static water-table HMC model variable(s)
        ...
        ! Static energy balance HMC model parameter(s)
        ...
        oHMC_Vars(iID)%a1dLDam = 0.0        ! to store info file
        oHMC_Vars(iID)%a1dHDam = 0.0
        ...
        oHMC_Vars(iID)%a2dVDam = -9999.0        ! to get dam storage curve 
        oHMC_Vars(iID)%a2dLDam = -9999.0        ! to get dam storage curve 
        ...
        ! Dynamic forcing variable(s)
        oHMC_Vars(iID)%a2dRain = 0.0            ! Rain              [mm]
        oHMC_Vars(iID)%a2dTa = 0.0              ! Air Temperature   [C]
        oHMC_Vars(iID)%a2dK = 0.0   
        oHMC_Vars(iID)%a2dW = 0.0   
        oHMC_Vars(iID)%a2dRHum = 0.0
        oHMC_Vars(iID)%a2dPres = 0.0
        oHMC_Vars(iID)%a2dSHeight = -9999.0     ! Snow Height       [cm]    --> Forcing for snow physics
        oHMC_Vars(iID)%a2dSKernel = -9999.0     ! Snow Kernel       [-]     --> Forcing for snow physics
        oHMC_Vars(iID)%a2dSCA = -9999.0         ! Snow Cover Area   [-]     --> Forcing for snow physics
        oHMC_Vars(iID)%a2dSQA = -9999.0         ! Snow Quality      [-]     --> Forcing for snow physics
        ...
        oHMC_Vars(iID)%a1dVDam = 0.0        ! to store info file in initializing phase step and dynamic for step >= 1
